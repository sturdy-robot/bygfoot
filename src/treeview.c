    ...
    for (i = 0; i < country_list->len; i++) {
        ...
        for (j = 0; j < g_strv_length(dir_split_up) - 1; j++) {
            ...
            if (iterators->len < j + 1) {
                ...
                gtk_tree_model_get((GtkTreeModel *) ls, (GtkTreeIter *) g_ptr_array_index(iterators, j), 1,
                                   &previous_element, -1);
            ...
            if (create_new_line) {
                ...
                if (j == 0) {
                    ...
                    gtk_tree_store_append(ls, (GtkTreeIter *) g_ptr_array_index(iterators, j),
                                          (GtkTreeIter *) g_ptr_array_index(iterators, j - 1));
                }
                ...
                if (j == g_strv_length(dir_split_up) - 2) {
                    ...
                    treeview_helper_insert_icon((GtkTreeModel *) ls, (GtkTreeIter *) g_ptr_array_index(iterators, j), 0,
                                                buf);
                }
