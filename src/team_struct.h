...
typedef struct team
{
    ...
    */
    ...
    /** If this is a reserve team, then this will be a pointer to the
     * 'first team'.  The team that this team is a reserve for.  If 
     * this is not a reserve team, then the value will be NULL.
     */
    union {
        int id;
        char *sid;
